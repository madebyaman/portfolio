...
export const projectsList: Project[] = [
  {
    name: "Virtualization Library",
    description:
      "A high-performance virtualization library for rendering large lists and tables efficiently. Only renders visible items, dramatically reducing DOM nodes and improving performance.\n\nTested with 500,000+ rows and renders at 60 FPS even on older devices and with CPU throttling.",
    highlighted: true,
    skills: [
      {
        name: "TypeScript",
  ...
  },
  {
    name: "Chord Key",
    description:
      "A keyboard shortcuts library for React with built-in conflict detection and discoverable shortcuts.\n\nMakes keyboard shortcuts easy to manage with centralized management, cross-platform support (Mac, Windows, Linux), TypeScript support, and uses Radix Tries for fast lookups.",
    highlighted: true,
    skills: [
      {
        name: "React",
